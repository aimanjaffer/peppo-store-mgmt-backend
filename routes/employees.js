...
router.post("/signup", async (req, res) => {
  ...
  router.get("/managers/store/:id", isLoggedIn, async (req, res) => {
    try{
  ...
  router.get("/deliveryagents/store/:id", isLoggedIn, async (req, res) => {
    try{
      const employees = await Employee.findAll({
        attributes: { exclude: ['employee_password'] },
  ...
  router.post("/deliveryagent/new", isLoggedIn, isAdminOrManager, async (req, res) => {
    try {
